...
#undef HEDLEY_GCC_VERSION
    ...
    !defined(HEDLEY_CRAY_VERSION) && !defined(HEDLEY_TI_VERSION) &&                                \
    ...
    !defined(__COMPCERT__) && !defined(HEDLEY_MCST_LCC_VERSION)
...
#undef HEDLEY_UNAVAILABLE
    ...
    HEDLEY_INTEL_VERSION_CHECK(13, 0, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#define HEDLEY_ASSUME(expr) _nassert(expr)
    ...
    HEDLEY_CRAY_VERSION_CHECK(10, 0, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#define HEDLEY_UNLIKELY(expr) __builtin_expect(!!(expr), 0)
    ...
    HEDLEY_CRAY_VERSION_CHECK(8, 1, 0) || HEDLEY_MCST_LCC_VERSION_CHECK(1, 25, 10)
...
#if HEDLEY_HAS_WARNING("-Wgcc-compat") // NOLINT(readability-redundant-preprocessor)
